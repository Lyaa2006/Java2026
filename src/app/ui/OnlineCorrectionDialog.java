...
public class OnlineCorrectionDialog extends JDialog {
    ...
    public OnlineCorrectionDialog(java.awt.Window owner, String richContent, String note, boolean editable, String lockedByDisplay) {
        ...
        if (editable) {
            ((AbstractDocument) filePane.getDocument()).setDocumentFilter(new RoleColorFilter(studentAttr));
        }
        ...
        rightPanel.add(new JLabel("评语（仅查看）"), BorderLayout.NORTH);
